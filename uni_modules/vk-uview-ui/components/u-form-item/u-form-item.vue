			...
			<view class="u-form-item--right u-flex">
				<view class="u-form-item--right__content">
					<view class="u-form-item--right__content__slot"
						:style="elLabelPosition == 'left' && elInputAlign == 'right' ? 'text-align:right;display: inline-block;line-height:initial;' : ''">
						<slot />
					</view>
...
<script>
	...
	export default {
		...
		computed: {
			...
			elInputAlign() {
				return this.inputAlign ? this.inputAlign : (this.parentData.inputAlign ? this.parentData.inputAlign :
					'left');
			},
		},
		methods: {
